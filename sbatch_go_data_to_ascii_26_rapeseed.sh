...
mkdir -p rpc_26
./DataToAscii -path Cluster -crop rapeseed -source /beegfs/rpm/projects/monica/out/sschulz_2347_2021-12-July_144819 -project /beegfs/rpm/projects/monica/project/soybeanEU -out ./rpc_26
