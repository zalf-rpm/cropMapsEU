...
def build() :
    ...
    outFiles = [
            "./stu_eu_layer_grid_management_Wheat_Winter.csv",
            "./stu_eu_layer_grid_management_Maize.csv",
    ]
    ...
    for idx in range(len(pathToGrids)):
        ...
        GenerateGridLookup(gridFile, outFiles[idx], ascii_data_array, header.ascci_cols, header.ascii_rows)
